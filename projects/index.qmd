...
## [HealthDataScotland](https://www.healthdatascotland.co.uk/){target="_blank"}
...
[documentation](https://jsleight1.github.io/HealthDataScotland/){target="_blank"}.

**Please note the container is not always running and may take a few moments to
load**

## [LGBFScotland](https://www.lgbfscotland.co.uk/){target="_blank"}
...
([LGBF](https://www.improvementservice.org.uk/products-and-services/data-intelligence-and-benchmarking/local-government-benchmarking-framework){target="_blank"})
...
project analysing this data set (see
[LGBF](https://github.com/jsleight1/LGBF){target="_blank"}). However a key
motivation for this new project was that I wanted to improve my skills in
developing packages with Python. The LGBF is publicly available and provides
some interesting insights into the performance of Scottish local authorities.
Therefore, I thought this would be a good data set to gain experience using
[Shiny for Python](https://shiny.posit.co/py/){target="_blank"} and developing
python packages using the [uv](https://docs.astral.sh/uv/){target="_blank"}
...
## [COVID-19 Scotland](https://jack-sleight.shinyapps.io/covid_shiny/){target="_blank"}
